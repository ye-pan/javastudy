...
public class AndExp implements BooleanExp {
    ...
    public AndExp(BooleanExp operate1, BooleanExp operate2) {
    ...
    public BooleanExp replace(BooleanExp source, BooleanExp target) {
        return new AndExp(operate1.replace(source, target), operate2.replace(source, target));
    }

    @Override
    public BooleanExp copy() {
        return new AndExp(operate1.copy(), operate2.copy());
    }
